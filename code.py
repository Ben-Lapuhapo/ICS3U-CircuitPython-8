...
def menu_scene():
    ...
    # used this program to split the iamge into tile: https://ezgif.com/sprite
    # /n cutter/ezgif-5-818cdbcc3f66.png
    ...
    text1 = stage.Text(width=29, height=14, font=None, palette=/n
                       constants.NEW_PALETTE, buffer=None)
    text1.move(20, 10)
    text1.text("MT Game Studios")
    text.append(text1)

    text2 = stage.Text(width=29, height=14, font=None, palette=/n
                       constants.NEW_PALETTE, buffer=None)
    text2.move(40, 110)
...
def game_scene():
    ...
    while True:
        ...
        if keys & ugame.K_X != 0:
            ...
            constants.button_state["button_just_pressed"]:
                a_button_pressed =
                constants.button_state["button_still_pressed"]
        else:
            a_button_pressed = constants.button_state["button_up"]
